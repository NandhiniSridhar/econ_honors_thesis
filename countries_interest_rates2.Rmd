...
colnames(year_totals_all) <- c("Fiscal_Year", "Average_Gross_Loan_Portfolio", "Average_Percent_Female_Borrowers", "Average_Fraction_GLP_To_Women", "Average_Number_Female_Borrowers")
...
colnames(year_totals) <- c("Fiscal_Year", "Average_Gross_Loan_Portfolio", "Average_Percent_Female_Borrowers", "Average_Fraction_GLP_To_Women", "Average_Number_Female_Borrowers")
...
ggplot(year_totals_all, aes(x=Fiscal_Year, y=Average_Fraction_GLP_To_Women)) +
  ...
  labs(title = "Average Fraction of GLP to Women Over Time Across all MFIs - All Data", x="Fiscal Year", y="Fraction of GLP to Female Borrowers")
...
ggplot(year_totals, aes(x=Fiscal_Year, y=Average_Fraction_GLP_To_Women)) +
  ...
  labs(title = "Average Fraction of GLP to Women Over Time Across all MFIs - Working Data", x="Fiscal Year", y="Average Fraction of GLP to Female Borrowers")
...
time_mfi_fe <- felm(Percent_of_female_borrowers ~ log(Gross_Loan_Portfolio) | MFI_Name + Fiscal_Year | 0 | MFI_Name, working_mf_interest)
summary(time_mfi_fe)

time_region_fe <- felm(Percent_of_female_borrowers ~ log(Gross_Loan_Portfolio) | Country.x + Fiscal_Year | 0 | MFI_Name, working_mf_interest)
summary(time_region_fe)

#include region fixed effects
time_region_fe <- felm(Percent_of_female_borrowers ~ log(Gross_Loan_Portfolio) | Region + Fiscal_Year | 0 | MFI_Name, working_mf_interest)
summary(time_region_fe)
...
fe_inst_2 <- feols(Percent_of_female_borrowers ~ predicted_log_GLP | MFI_Name + Fiscal_Year, cluster="MFI_Name", data=working_mf_interest)
summary(fe_inst_2)
```
...
fe_inst_2 <- feols(Percent_of_female_borrowers ~ predicted_log_GLP | Country.x + Fiscal_Year, cluster="MFI_Name", data=working_mf_interest)
summary(fe_inst_2)
```
...
time_mfi_fe <- felm(Ratio_GLP_Female ~ log(Gross_Loan_Portfolio) | MFI_Name + Fiscal_Year | 0 | MFI_Name, working_mf_interest)
summary(time_mfi_fe)

#negative coef

#include region fixed effects
time_region_fe <- felm(Ratio_GLP_Female ~ log(Gross_Loan_Portfolio) | Region + Fiscal_Year | 0 | MFI_Name, working_mf_interest)
summary(time_region_fe)
```
...
fe_inst_2 <- feols(Ratio_GLP_Female ~ predicted_log_GLP | Region + Fiscal_Year, cluster="MFI_Name", data=working_mf_interest)
summary(fe_inst_2)
```
