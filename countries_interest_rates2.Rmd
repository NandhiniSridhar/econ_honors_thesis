...
Includes both time and MFI fixed effects and interest rate as an instumental variable
```{r}
#use this!!!
...
fe_inst_2 <- felm(working_mf_interest$Ratio_GLP_Female ~ working_mf_interest$predicted_GLP | MFI_Name + Fiscal_Year | 0 | MFI_Name, working_mf_interest)
